...
<template>
	...
	<ModalBottomSheet bus="NavBarModal">
		<router-link to="/start-video/private"> <Icon>videocam</Icon>Filmer pour moi </router-link>
		<router-link to="/start-video/public"> <Icon>cell_tower</Icon>Filmer & Diffuser </router-link
