...
<template>
	...
	<ModalBottomSheet bus="TopAppBarModal">
		<router-link to="create-group"> <Icon>groups</Icon>Créer un groupe </router-link>
		<button @click="switchMode"><Icon>dark_mode</Icon>Mode nuit</button>
		<router-link to="settings"> <Icon>settings</Icon>Paramètres </router-link>
	</ModalBottomSheet>
</template>
